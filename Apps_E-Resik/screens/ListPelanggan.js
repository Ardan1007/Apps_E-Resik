            ...
            >
              <VStack space={2}>
                ...
                <HStack space={2} mt={2}>
                  ...
                  >
                    <Text color={"#0878CA"}>Detail Pelanggan</Text>
                  </Button>
                  <IconButton
                ...
                <Modal.Body>
                  <VStack space={3}>
                    <HStack alignItems="center" justifyContent="space-between">
                      ...
                      <Text color="blueGray.400">{selectedCustomer.nama}</Text>
                    </HStack>
                    <HStack alignItems="center" justifyContent="space-between">
                      <Text fontWeight="medium">Jenis Kelamin</Text>
                      <Text color="blueGray.400">
                        {selectedCustomer.jenisKelamin}
                      </Text>
                    </HStack>
                    <HStack alignItems="center" justifyContent="space-between">
                    ...
                    <HStack alignItems="center" justifyContent="space-between">
                      ...
                      <Text color="blueGray.400">{selectedCustomer.noHp}</Text>
                    </HStack>
